...
export default function MySQLToSinglestoreComponent({
  ...
  const { mySQLHost, selectedTables } = useMySQLMigrationStore()
  ...
  const { singlestoreDatabases, mongoHost } = useDatabaseMigrationStore()
  ...
  return (
    <Box>
      ...
      <Stack direction="row" my={2}>
        {selectedTables?.map((collectionName, i) => (
